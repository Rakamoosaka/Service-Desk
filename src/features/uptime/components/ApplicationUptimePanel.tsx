    ...
    <Card>
      <CardContent className="space-y-6">
        {uptimeQuery.isFetching ? (
          <InlineNotice
            title="Refreshing uptime"
            description="Live monitor and incident data is being refreshed in the background."
          />
        ) : null}

        {uptimeQuery.isError && !snapshot ? (
          <ErrorState
            title="Unable to load uptime data"
            description={uptimeQuery.error.message}
            action={
              <Button
                size="sm"
                variant="secondary"
        ...
        {uptimeQuery.isLoading && !snapshot ? (
          <LoadingState
            title="Loading uptime data"
            description="Fetching live monitor health, incidents, and response metrics."
          />
        ) : null}
