    ...
    return (
      ...
      >
        ...
        <SelectPrimitive.Trigger
          ...
          onClick={onClick}
          className={cn(
            "group border-border bg-input/90 data-face text-foreground focus-visible:ring-accent/30 relative flex w-full items-center justify-between text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_12px_30px_rgba(0,0,0,0.16)] transition duration-200 outline-none before:pointer-events-none before:absolute before:inset-px before:bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.015))] hover:-translate-y-px hover:border-white/16 hover:bg-white/6 focus-visible:ring-4 disabled:cursor-not-allowed disabled:opacity-55",
            size === "sm"
              ...
              {options.map((option) => {
                ...
                return (
                  <SelectPrimitive.Item
                    ...
                    className="data-highlighted:bg-accent/12 relative flex min-h-10 cursor-default items-center gap-3 rounded-[14px] px-3.5 py-2.5 text-sm transition outline-none data-disabled:pointer-events-none data-disabled:opacity-35 data-highlighted:text-white data-[state=checked]:bg-white/6"
                  >
